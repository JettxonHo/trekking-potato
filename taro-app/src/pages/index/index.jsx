...
import { View, Text, Input, Picker, Image, ScrollView, PageContainer, Checkbox, CheckboxGroup } from '@tarojs/components'
import LogoIcon from '../../assets/new_logo.png'
import { Button, Cell, CellGroup, Tag, Skeleton, Popup, Radio, RadioGroup } from '@nutui/nutui-react-taro'
...
export default class Index extends Component {
  ...
  render() {
    const { route, date, startTimeLocal, days, levels, levelIndex, minDate, loadingStage, tripFlow, manualLat, manualLon, manualElev, manualRouteType, routeTypeLabels, routeTypeOptions, climbSupport, climbSupportLabels, showHistory, historyList, historyLoading, historyError, historySaveError, historyPrefillNotice, gearChecked, trackUi } = this.state
