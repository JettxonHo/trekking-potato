...
than using invented values. I14's contract is merged and its implementation proceeds from the frozen I07
...
| M4 Weather and verdict | Active — I14 implementation | I14–I16 | Hourly windows and `TP-VERDICT-1` are deterministic |
