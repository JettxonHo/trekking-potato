...
async function main() {
  ...
  assert(candidateSelectSource.includes('this._showBaseAndFetchAdvice(base, result.queryId, historyParams, generation)'), 'confirm base 必须只把本地 historyParams 与可信 queryId/generation 交给 base→advice 流程')
